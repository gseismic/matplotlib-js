...
function set_canvas_size(canvas, use_parent_size=true)
{
    ...
    if (use_parent_size) {
        ...
        canvas.setAttribute('style', 'width:' + canvas.parentNode.offsetWidth + 'px;height:' + canvas.parentNode.offsetHeight + 'px;')
    } else {
